                ...
                <div>
                    <h4 className="text-sm font-semibold mb-2">{t('smart_messaging.personalization.title')}</h4>
                     <div className="flex items-center gap-4">
                        ...
                        <input type="range" min="0" max="100" step="50" value={sliderValue} onChange={handleSliderChange} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700"/>
