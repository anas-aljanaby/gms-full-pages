...
import type { LeadershipData, Event, EventCategory, EventType, TeamMember, StudentProject } from '../../../types';
...
interface LeadershipCalendarViewProps {
...
const LeadershipCalendarView: React.FC<LeadershipCalendarViewProps> = ({ leadershipData, dispatch }) => {
      ...
      <div className="bg-card dark:bg-dark-card p-4 sm:p-6 rounded-2xl shadow-soft animate-fade-in space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <button onClick={handlePrevMonth} title={t('leadership.calendar.previousMonth')} className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-slate-700">
            ...
            <button onClick={handleNextMonth} title={t('leadership.calendar.nextMonth')} className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-slate-700">
              <span className="transform rtl:rotate-90 ltr:-rotate-90 inline-block"><ChevronDownIcon /></span>
            </button>
...
export default LeadershipCalendarView;