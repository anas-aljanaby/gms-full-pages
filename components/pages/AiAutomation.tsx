...
const AiAutomation: React.FC<AiAutomationProps> = (props) => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'insights_generator': return <AIInsightsGenerator donors={props.donors} beneficiaries={props.beneficiaries} projects={props.projects} />;
