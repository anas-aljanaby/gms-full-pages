    ...
    <div ref={dropdownsRef} className="bg-card dark:bg-dark-card p-2 rounded-xl shadow-soft dashboard-controls">
      <div className="flex flex-col md:flex-row items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={onCustomizeClick} title="Customize Layout" className="p-2 h-full rounded-lg border dark:border-slate-600 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors">
